"""
Background Subtraction Detector implementation.

This module provides a simple background subtraction based detector
...
class BackgroundSubtractionDetector(BaseDetector):
    """
    Background Subtraction based object detector.

    Uses background subtraction to detect moving objects in the frame,
    then applies simple classification to identify humans.
    """

    def __init__(self, config: Dict[str, Any] = None):
        """
        Initialize the background subtraction detector.

        Args:
            config: Configuration dictionary
        """
        super().__init__(config)
        self.name = "background_subtraction"
    ...
    def load_model(self) -> None:
        ...
        For background subtraction, this creates the background subtractor object.
        """
        ...
        logger.info("Background subtraction model loaded")
    ...
    def detect(self, frame: np.ndarray) -> List[Any]:
        ...
        for contour in contours:
            ...
            # Simple human classification based on aspect ratio
            aspect_ratio = h / w
